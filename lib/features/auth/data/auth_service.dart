...
class AuthService {
  ...
  static Future<User?> signInWithEmailPassword(
    ...
    try {
      ...
      if (userCredential.user != null) {
        final shouldLogout = await _checkIfShouldLogout(
      ...
      DebugLogger.error('Error signing in', e);
      return null;
    }
  }
  ...
  static Future<void> signOut({bool logoutAllDevices = true}) async {
    try {
      ...
      DebugLogger.error('Error signing out', e);
    }
  }
  ...
  static Future<bool> changePassword({
    ...
    try {
      ...
      DebugLogger.error('Error changing password', e);
      return false;
    }
  }
  ...
  static Future<bool> _checkIfShouldLogout(String uid) async {
    try {
      ...
      DebugLogger.error('Error checking logout status', e);
      return false;
    }
  }
  ...
  static Future<bool> sendEmailVerification() async {
    try {
      ...
      DebugLogger.error('Error sending verification email', e);
      return false;
    }
  }
  ...
  static Future<bool> sendPasswordResetEmail(String email) async {
    try {
      ...
      DebugLogger.error('Error sending password reset email', e);
      return false;
    }
  }
  ...
  static Future<bool> confirmPasswordReset(
    ...
    try {
      ...
      DebugLogger.error('Error confirming password reset', e);
      return false;
    }
  }
  ...
  static Future<String?> verifyPasswordResetCode(String code) async {
    try {
      ...
      DebugLogger.error('Error verifying password reset code', e);
      return null;
    }
  }
}
