...
//         title: AppText(title:'مبروك! خصم ${win['discountPercent'] ?? ''}%'),
//         content: AppText(title:'العرض: ${win['label'] ?? 'عرض'}\nالكود: ${win['code'] ?? 'سيتم إرساله'}'),
//         actions: [TextButton(onPressed: () => Navigator.pop(context), child: const AppText(title:'تم'))],
//       ),
//     );
...
//     if (items.isEmpty) {
//       // لا توجد عروض
//       return const AppText(title:'لا توجد عروض متاحة الآن');
//     }
...
//               SizedBox(height: 8.h
// ),
//               AppText(title:'خصم ${only['discountPercent'] ?? ''}%'),
//               SizedBox(height: 12.h
// ),
//               FilledButton(
//                 onPressed: () => _giveReward(only),
//                 child: const AppText(title:'احصل على العرض'),
//               ),
//               SizedBox(height: 6.h
// ),
//               AppText(title:'**نصيحة**: أضف أكثر من عرض لتفعيل عجلة الحظ 😉',
...
//         SizedBox(height: 8.h
// ),
//         FilledButton(onPressed: _spin, child: const AppText(title:'لف العجلة')),
//       ],
//     );
//   }
// }
